            ...
            <div className="row pt-4">
                ...
                <div className="col-lg-3 col-md-6 col-sm-10 col-xm-10 mx-auto position-relative">
                    <div className="client mt-1 p-2">
                        <img src={Img} className="img-tickets align-self-center rounded" width="90" height="80" alt=""/>
                        <Link to="/Event" className="text-capitalize mb-0 p-2 h-6-trick Link-Tickets">ul-ux design event 2020</Link>
